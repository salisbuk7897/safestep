...
namespace SafeStep___Desktop__WinForms_
{
    ...
    public partial class Options : Form
    {
        ...
        private void btnSaveOptions_Click(object sender, EventArgs e)
        {
            ...
            string port1 = cmbPort1.SelectedItem?.ToString() ?? "";
            string port2 = cmbPort2.SelectedItem?.ToString() ?? "";
            string port3 = cmbPort3.SelectedItem?.ToString() ?? "";
            string port4 = cmbPort4.SelectedItem?.ToString() ?? "";
            string baudRate = cmbOptionsBaudRate.SelectedItem?.ToString() ?? "115200";
            string deviceFilter = txtDeviceFilter.Text.Trim();
            bool autoConnect = chkAutoConnect.Checked;
