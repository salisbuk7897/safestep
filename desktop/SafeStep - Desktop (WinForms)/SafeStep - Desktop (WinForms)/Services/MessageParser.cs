...
namespace SafeStepDesktop.Services
{
    ...
    ///   ID=TAG001;NAME=John;BAT=87;Z1=0;Z2=1;Z3=0;RSSI=-62
    ///
    ...
    public static class MessageParser
    {
        ...
        /// </summary>
        /// <param name="raw">One raw line received from the serial port, e.g. "ID=TAG001;NAME=John;BAT=87;Z1=0;Z2=1;Z3=0"</param>
        ...
        public static SafeStepMessage? Parse(string raw)
        {
            ...
            // This handles optional fields like RSSI and PING gracefully.
            return new SafeStepMessage
            {
                ...
                // Optional fields — default to empty string / alive if not present
